...
-- ============================================================
-- 3. MÓDULO DE USUARIOS Y SEGURIDAD (Movido para evitar errores FK)
-- ============================================================
...
-- ------------------------------------------------------------
-- 3.3 Rol-Permiso (relación muchos a muchos)
-- ------------------------------------------------------------
...
-- ============================================================
-- 4. MÓDULO DE PRODUCCIÓN Y TRAZABILIDAD
-- ============================================================
...
INSERT INTO Estacion (nombre, tipo, protocolo, is_repair) VALUES
    ('Etiquetado-L1',  'Automático', 'MQTT',   0),
